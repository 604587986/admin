...
<template>
  <div id="jiaoshiyuyuehuishouzhan">
    <!-- 面包屑 -->
    ...
    <div class="table-container">
      ...
      <div class="table-body">
        <el-table ref="multipleTable" :data="tableInfo" stripe size="small" @selection-change="handleSelectionChange">
          ...
          <el-table-column prop="id" label="申请教室"></el-table-column>          
  ...
  methods: {
    ...
    getData() {
      ...
      that
        .$http({
          method: "get",
          url: "/Admin/Classroomsubscribe/dellist",
          params: {
      ...
      that
        ...
        .then(() => {
          that
            .$http({
              method: "get",
              url: "/Admin/Classroomsubscribe/delete",
              params: {
                application_num: id
              }
            })
      ...
      that
        ...
        .then(() => {
          that
            .$http({
              method: "get",
              url: "/Admin/Classroomsubscribe/restore",
              params: {
                application_num: id
              }
            })
