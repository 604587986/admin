...
<template>
  <div id="baobeiguanli">
    ...
    <div class="table-container">
      ...
      <router-link to="/pages/system_administrators/System_Administrators/baobeihuishouzhan"><el-button type="primary" size="mini" style="float:right;">回收站</el-button>  </router-link> 
      ...
      <div class="table-body">
        <el-table ref="multipleTable" :data="tableInfo" stripe size="small" @selection-change="handleSelectionChange" @sort-change="sort" :default-sort="{prop:'request_num'}">
          ...
          <el-table-column prop="course" label="报备课程"></el-table-column>         
          <el-table-column prop="classroom" label="报备教室"></el-table-column>         
          <el-table-column prop="attend_time" label="上课时间" sortable='custom'></el-table-column>         >                              
          ...
          <el-table-column label="操作">
            <div slot-scope="scope" class="control-btn">
              <router-link :to="{path:'/pages/system_administrators/System_Administrators/baobeixiangqing',query:{id:scope.row.id}}"><el-button size="small">详情</el-button></router-link>
      ...
      that
        ...
        .then(function(res) {
          if (res.data.code == 6) {
            ...
            that.tableInfo = res.data.report;
