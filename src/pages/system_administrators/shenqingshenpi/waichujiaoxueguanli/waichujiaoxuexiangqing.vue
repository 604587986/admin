...
<template>
  <div id="waichujiaoxuexiangqing" class="detail-wrapper">
    <!-- 面包屑 -->
    ...
    <el-card class="box-card">
      ...
      <div class="body">
        ...
        <p><label>原上课时间:</label><span>{{dataList.course_time}}</span></p>        
        <p><label>课程名称:</label><span>{{dataList.course}}</span></p>
        <p><label>上课班级:</label><span>{{dataList.grade}}</span></p>
        <p><label>申诉理由:</label><span>{{dataList.excuse}}</span></p>
      </div>
    </el-card>
  <!-- 审核信息 -->    
    <el-card class="box-card">
    ...
    return {
      ...
      crumbs: [
        ...
        },
        {
          name: "外出教学管理",
          url:
            "/pages/system_administrators/System_Administrators/waichujiaoxueguanli"
        },
        {
          name: "外出教学详情",
          url: ""
