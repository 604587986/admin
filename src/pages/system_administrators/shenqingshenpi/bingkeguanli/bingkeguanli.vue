...
<template>
  <div id="bingkeguanli">
    ...
    <div class="table-container">
      ...
      <router-link to="/pages/system_administrators/System_Administrators/bingkehuishouzhan"><el-button type="primary" size="mini" style="float:right;">回收站</el-button>  </router-link> 
        ...
        <el-table ref="multipleTable" :data="tableInfo" stripe size="small" @selection-change="handleSelectionChange">
          ...
          <el-table-column label="操作">
            <div slot-scope="scope" class="control-btn">
              <router-link :to="{path:'/pages/system_administrators/System_Administrators/bingkexiangqing',query:{id:scope.row.id}}"><el-button size="small">详情</el-button></router-link>
