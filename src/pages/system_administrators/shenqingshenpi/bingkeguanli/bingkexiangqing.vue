...
<template>
  <div id="bingkexiangqing" class="detail-wrapper">
    <!-- 面包屑 -->
    ...
    <el-card class="box-card">
      ...
      <div class="body">
        ...
        <p><label>并课课程:</label><span>{{dataList.combine_course}}</span></p>
        <p><label>上课班级:</label><span>{{dataList.squad_one}}</span></p>
        <p><label>上课时间:</label><span>{{dataList.time_one}}</span></p>
        <p><label>对方课程:</label><span>{{dataList.other_course}}</span></p>
        <p><label>对方班级:</label><span>{{dataList.squad_two}}</span></p>
        <p><label>对方上课时间:</label><span>{{dataList.time_two}}</span></p>
        <p><label>并课后上课时间:</label><span>{{dataList.date}}</span></p>
        <p><label>并课理由:</label><span>{{dataList.reason}}</span></p>
      </div>
    </el-card>
  <!-- 审核信息 -->    
    <el-card class="box-card">
