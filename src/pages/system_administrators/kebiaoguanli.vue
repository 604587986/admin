    ...
    <div class="table-container">
      ...
      <div class="table-body">
        <el-table ref="multipleTable" :data="tableInfo" stripe size="small">
          ...
          <el-table-column prop="tableId" label="课表编码" width="150"></el-table-column>
          <el-table-column prop="class" label="班级名称" width="100"></el-table-column>
          <el-table-column prop="department" label="所属系" width="150"></el-table-column>
          <el-table-column prop="date" label="学年学期" width="150"></el-table-column>
