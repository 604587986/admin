        ...
        <el-table ref="multipleTable" :data="tableInfo" stripe size="small" @selection-change="handleSelectionChange" @sort-change="sort" :default-sort="{prop:'id'}">
          ...
          <el-table-column label="操作">
            <div slot-scope="scope"  class="control-btn">
              <router-link :to="{path:'/pages/system_administrators/System_Administrators/xinxiqunfaxiangqing',query:{id:scope.row.id}}"><el-button size="mini" type="success">详情</el-button></router-link>
              <el-button size="mini" type="warning" @click="deleteRow(scope.$index, scope.row.id,tableInfo)">删除</el-button>
            </div>
          </el-table-column>               
        </el-table>
      </div>
