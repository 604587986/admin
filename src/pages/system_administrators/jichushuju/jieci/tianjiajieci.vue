    ...
    <div id="tianjiabanji">
        ...
        <div class="form-container">
            ...
            <el-form ref="form" :model="form" :rules="rules" status-icon label-width="108px" size="mini" label-position="right">
                ...
                <el-form-item label="时间段：" class="form-item" prop="time_quantum_id">
                    <el-select v-model="form.time_quantum_id" clearable placeholder="请选择" size="mini" class="float-left column-selection">
  ...
  methods: {
    ...
    getData() {
      ...
      that
        ...
        .then(function(res) {
          that.dataList = res.data.time_quantum;
        });
    },
