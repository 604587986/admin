  ...
  <div id="jieci">
    ...
    <div class="table-container">
      ...
      <div class="table-filter">  
          <router-link to="/pages/system_administrators/System_Administrators/jiecihuishouzhan"><el-button type="primary" size="mini" style="float:right;">回收站</el-button>  </router-link>      
          <router-link to="/pages/system_administrators/System_Administrators/tianjiajieci"><el-button type="primary" size="mini" style="float:right;margin-right:10px">添加节次</el-button></router-link>   
      </div>
      <!-- 表格 -->
      <div class="table-body">
          ...
          <el-table-column label="操作">
            <div slot-scope="scope"  class="control-btn">
              <router-link :to="{path:'/pages/system_administrators/System_Administrators/bianjijieci',query:{id:scope.row.id}}"><el-button  size="mini">编辑</el-button></router-link>
      ...
      that
        ...
        .then(function(res) {
          if (res.data.code == 6) {
            ...
            that.tableInfo = res.data.section;
