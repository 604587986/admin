  ...
  <div id="jiaoshiliebiao">
    ...
    <div class="table-container">
      ...
      <div class="table-filter">
        ...
        <el-input placeholder="请输入名称或工号" v-model="searchValue" class="input-with-select title-search float-left" size="mini">
        </el-input>
          <el-button type="primary" @click="articleSearch()" size="mini" style="margin-left:20px">搜索</el-button>     
          <router-link to="/pages/system_administrators/System_Administrators/jiaoshihuishouzhan"><el-button type="primary" size="mini" style="float:right;">回收站</el-button>  </router-link>      
          <router-link to="/pages/system_administrators/System_Administrators/tianjiajiaoshi"><el-button type="primary" size="mini" style="float:right;margin-right:10px">添加教师</el-button></router-link>   
      </div>
      <!-- 表格 -->
      <div class="table-body">
        <el-table ref="multipleTable" :data="tableInfo" stripe size="small" @selection-change="handleSelectionChange" @sort-change="sort" :default-sort="{prop:'id'}">
          ...
          <el-table-column prop="faculty_id" label="部门"></el-table-column>                    
          <el-table-column prop="duty" label="职务"></el-table-column>                    
          <el-table-column prop="tel" label="电话"></el-table-column>     
          <el-table-column label="操作">
            <div slot-scope="scope"  class="control-btn">
              <router-link :to="{path:'/pages/system_administrators/System_Administrators/bianjijiaoshi',query:{id:scope.row.id}}"><el-button  size="mini">编辑</el-button></router-link>
